...
DVAP is an application security platform for repository assessment workflows. It presents the operator experience of an enterprise AppSec product: repository intake, analyzer orchestration, normalized findings, security evidence, and platform documentation.
...
- Keep the UI dense, product-oriented, and suitable for repeated operator workflows.
- Expose documentation pages with both direct integration names and generic repository references.
...
- **Events:** security-signal activity with assessment filters.
- **Docs:** platform reference pages for integrations, repository metadata, policies, and workflows.

## Assessment Programs

| Program | Operator framing |
|---|---|
...
- CI/CD integrations, repository intake, documentation ingestion, and repository management.
- Policy management, finding lifecycle, developer workflows, asset inventory, reporting, and triage.

Some pages mention known security products directly. Other pages use generic repository signals and operating concepts so automation can resolve both direct and indirect references.
